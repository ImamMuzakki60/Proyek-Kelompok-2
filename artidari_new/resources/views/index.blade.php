    ...
    <div class="w-screen bg-artidari-alabaster">
        ...
        <div class="flex justify-center py-20">
            <div class="bg-white w-[46rem] border-4 rounded-xl border-black py-8 px-10">
                ...
                @endif
                <p class="font-light text-sm leading-none">by <span class="text-artidari-celestial-blue">{{$kataHariIni->user->username}}</span></p>
        ...
        <div class="flex justify-center pb-10">
            <div class="w-[46rem]">
                ...
                <div class="py-4 px-10">
                    ...
                    @endif
                    <p class="font-light text-sm leading-none">by <span class="text-artidari-celestial-blue">{{$kata->user->username}}</span></p>
