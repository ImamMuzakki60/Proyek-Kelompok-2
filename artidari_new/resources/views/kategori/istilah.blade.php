...
<body>
    ...
    <header class="w-screen h-24 bg-artidari-space-cadet">
        ...
        <div class="flex justify-center gap-x-5 mt-5 text-white text-sm">
            <div>
                <a href="/istilah" class="border-b-2 border-white">Istilah Regional</a>
            </div>
            <div>
    ...
    <div class="w-screen h-48 bg-white pt-14">
        <div class="flex justify-center">
            <p class="text-3xl font-semibold">ISTILAH REGIONAL</p>
        </div>
        <div class="flex justify-center mx-52">
            <p class="text-sm text-center">Pernah penasaran kenapa orang dari satu daerah bisa punya kata-kata unik yang bikin kamu bingung? Itulah keunikan dari Istilah Regional. Setiap sudut negeri punya jargon dan slang yang lahir dari budaya, sejarah, dan kebiasaan lokal mereka. Seperti ‘turu’ di Jawa atau ‘onde mande’ di Sumatera, istilah-istilah ini lebih dari sekadar kata, tapi cerminan identitas daerah yang kaya dan berwarna-warni.</p>
        </div>
    </div>
    ...
    <div class="w-screen bg-artidari-alabaster py-10">
        ...
        <div class="flex justify-center">
            <div class="w-[46rem]">
                <p class="text-xl font-normal">ISTILAH REGIONAL POPULER</p>
            </div>
        </div>
            
        {{-- Istilah Regional --}}
        @if($kataIstilah && $kataIstilah->isNotEmpty())
            @foreach($kataIstilah as $kata)
                <x-card :kata="$kata" />
            @endforeach
        @else
            <div class="flex justify-center py-20 ">
                <div class="bg-white w-[46rem] border-4 rounded-xl border-black py-8 px-10">
                    <p class="font-medium text-3xl text-artidari-celestial-blue my-1">Tidak ada istilah regional</p>
                </div>
            </div>
        @endif
